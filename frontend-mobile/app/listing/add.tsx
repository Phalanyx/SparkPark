    ...
    try {
      ...
      const payload = {
        ...
        availability: availabilityList.map(slot => ({
          date: slot.date,
          availableFrom: slot.availableFrom.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', hour12: false }),
          availableUntil: slot.availableUntil.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', hour12: false })
        })),
        features: features,
      };
